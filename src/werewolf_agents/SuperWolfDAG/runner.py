...
agent_config = PlayerAgentConfig(
    ...
    agent_wheel_path="/Users/akanodia/werewolf-template/src/werewolf_agents/SuperWolfDAG/dist/chagent-0.1.0-py3-none-any.whl", 
...
game_results = runner.run_locally(
    ...
    path_tu_final_transcript_dump="transcripts",
